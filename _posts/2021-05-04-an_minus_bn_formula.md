...
My immediate thought was to figure out how someone could had come up with that formula in the first place. After pondering about it a little bit, and of course, searching the internet, I learned about the derivation described below.

Allegedly, one way to derive the expansion introduced above is to think about the sum of geometric series. As a reminder, here we have the well-known formula for the sum of the first $$n$$ terms of geometric series:
...
At this point, our expression starts to reminisce our ultimate goal stated at the beginning. However, there is one more substitution to be done before pure algebraic manipulations come into place. Admittedly, I could not come up with this substitution quickly by myself. The truth is that I did not try for too long, but still, I feel that ideas of this type are one of my weaknesses. I reckon it takes a little bit of insight into the problem itself and a good deal of creativity. Nevertheless, for the sake of learning, I consider the solution to be applicable in general. Basically, always keep asking yourself where you want to get in the end. Whether it is proving a theorem or just solving a problem. And keep in mind that substitution is a reasonable approach to take. Remember how integration can be simplified by substitution. Speaking of integration, change in coordinates comes to mind, too. Trigonometric equations are also often tackled with substitution. I remember that I have encountered many times how substituion did the whole magic. I look at this problem through similar lens. So, what should we substitute for $$x$$, then? Think of it this way. We want to transform the expression $$1 - x^n$$ into $$a^n - b^n$$. Thus, let's go with $$x = \frac{b}{a}$$, which yields
...
This problem reminds me one talk by Simon Sinek regarding how people cannot ignore the negative ([see here](https://www.youtube.com/watch?v=W05FYkqv7hM)). Let me elaborate. He started to talk by showing that people cannot avoid thinking of an elephant when told "do not think of an elephant". Later on he expanded on this idea by discussing how skiiers should not focus on "not hitting the trees" but should focus on "staying on the path". In essence, I have encountered something similar with this problem as well.
